<?php
class ZWPLCC_Plugin_Autoloader{
	...
	*/
	public function autoloadEngine( $class ){
		$prefix   = zwplcc_config( 'namespace' ) .'\\';
		$base_dir = ZWPLCC_PATH .'engine/';
	...
	*/
	public function autoloadComponents( $class ){
		$prefix   = zwplcc_config( 'namespace' ) .'\\Component\\';
		$base_dir = ZWPLCC_PATH .'components/';
